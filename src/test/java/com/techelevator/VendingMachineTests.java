...
public class VendingMachineTests {
	...
	public void passing2Dollars_return2DollarsBalance() {
		...
		BigDecimal balance = myMachine.addToCustomerMoney(2);
		Assert.assertEquals(new BigDecimal(2.00).setScale(2), balance);
	}
	...
	public void passing0Dollars_returnZeroDollarsBalance() {
		...
		VendingMachine myMachine = new VendingMachine();
		BigDecimal balance = myMachine.addToCustomerMoney(0);
		Assert.assertEquals(new BigDecimal(0.00).setScale(2), balance);
	}
	...
	public void passing3Dollars_returnThreeDollarsBalance() {
		...
		VendingMachine myMachine = new VendingMachine();
		BigDecimal balance = myMachine.addToCustomerMoney(3);
		Assert.assertEquals(new BigDecimal(0.00).setScale(2), balance);
	}
